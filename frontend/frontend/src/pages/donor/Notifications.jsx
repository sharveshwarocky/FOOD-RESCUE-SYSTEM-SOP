...
const DonorNotifications = () => {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-2xl font-bold text-slate-800">Donor Notifications</h2>
        <p className="text-xs text-slate-500 mt-0.5">Updates on NGO food requests, volunteer pickup, and delivery confirmation</p>
      </div>
